import os, sys, math, time, zipfile, subprocess
from subprocess import Popen, PIPE
try:
        import cv2
        import numpy as np
except:
        print "does not have numpy or cv2 installed"
...
def getTranslationMatrix2d(dx, dy):
    """
    Returns a numpy affine transformation np.matrix for a 2D translation of
    (dx, dy)
    """
